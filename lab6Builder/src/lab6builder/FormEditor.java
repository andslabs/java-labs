...
import lab6builder.rtf.RtfReader;
...
public class FormEditor extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        rtfMenu = new javax.swing.JMenu();
        convertItem = new javax.swing.JMenuItem();
        ...
        convertItem.setText("Convert to HTML");
        convertItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                convertItemActionPerformed(evt);
            }
        });
        rtfMenu.add(convertItem);

        jMenuBar1.add(rtfMenu);
    ...
    private void convertItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_convertItemActionPerformed
        if (isOpened) {
            try {
                String fileName = openedFile.getName();
                String newFileName = fileName.substring(0, fileName.length() - 3) + "html";
                System.out.println("new file name: " + newFileName);
                Files.write(Paths.get(newFileName), rtf.convertToHtml().getBytes(StandardCharsets.UTF_8));
                showMessage("Successfully converted to html");
            } catch (IOException e) {
    ...
    }//GEN-LAST:event_convertItemActionPerformed
    ...
    private File openFile() {
        ...
        fileChooser.addChoosableFileFilter(new FileNameExtensionFilter("RTF files", "rtf"));
                ...
                if (isOpened) {
                    ...
                    if (openedFile != null) {
                        try {
                            ...
                            if (!content.equals("")) {
                                if (openedFile.getName().endsWith("rtf")){
                                    rtf = new RtfReader(content);
                                    content = rtf.getText();
    ...
    private javax.swing.JMenuItem convertItem;
    ...
    private javax.swing.JMenu rtfMenu;
